...
*/
if(!class_exists('AQ_Carousel_Posts_Block')) {
	class AQ_Carousel_Posts_Block extends AQ_Block {
		...
		function __construct() {
			...
			parent::__construct('aq_carousel_posts_block', $block_options);
		...
		function block($instance) {
			...
			echo '<div class="aq-carousel-posts-block">';
					$args = array(
					...
					global $post;
						...
						echo '<div class="'.implode(', ', get_post_class()).' carousel-post">';
							...
							echo '<span class="avg-score">';
								echo overall_rating();
							echo '</span>';
							echo '<h5 class="the-title marT0 marB10"><a href="'.get_permalink().'">'. get_the_title() .'</a></h5>';
							echo '</div>';
