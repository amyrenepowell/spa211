	...
	class AQ_Team_Member_Block extends AQ_Block {
		...
		function block($instance) {
			...
			<?php echo '<div class="member-info">';
				...
				echo '<ul class="marB0">';
					if($facebook) echo '<li><a href="'.strip_tags($facebook).'"><i class="icon-facebook"></i></a></li>';
					if($twitter) echo '<li><a href="'.strip_tags($twitter).'"><i class="icon-twitter"></i></a></li>';
					if($linkedin) echo '<li><a href="'.strip_tags($linkedin).'"><i class="icon-linkedin"></i></a></li>';
					if($google) echo '<li><a href="'.strip_tags($google).'"><i class="icon-google-plus"></i></a></li>';				
				echo '</ul>';
			echo '</div>';
		}
